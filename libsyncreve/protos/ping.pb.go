...
type PingServiceClient interface {
	PingServer(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResult, error)
}
...
func (c *pingServiceClient) PingServer(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResult, error) {
	out := new(PingResult)
	err := c.cc.Invoke(ctx, "/PingService/PingServer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PingServiceServer interface {
	PingServer(context.Context, *PingRequest) (*PingResult, error)
}
...
func (*UnimplementedPingServiceServer) PingServer(context.Context, *PingRequest) (*PingResult, error) {
...
func _PingService_PingServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/PingService/PingServer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PingServiceServer).PingServer(ctx, req.(*PingRequest))
	}
