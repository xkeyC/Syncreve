                  ...
                  SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "${filesize(itemData.status == Downloader.fileDownloadQueueStatusDone ? (itemData.totalSize ?? 0) : (itemData.downloadedSize ?? 0))}${itemData.status == Downloader.fileDownloadQueueStatusDownloading ? "/${filesize(itemData.totalSize ?? 0)}" : ""} ${model.getDownloadStatusText(itemData.status)} "
